  ...
  <Layout>
    ...
    <div className="container">
        ...
        <div className="column">
          <center>
            ...
            <h5>
              ...
              <font color="#e43ea7">sideProject</font>()
              <font color="#095885">;</font>
              <font color="#B3B3B3">{' } '}</font>
            </h5>
          </center>
        </div>
      ...
      <div className="columns">
        <div className="column">
          <p>
            Currently working in London as a doctor; designing and building
            products in my spare time.
          </p>
          <p>
            I personally enjoy working on projects that require both strategy as
            well as visual design. I love working on problems within the
            health-tech space; from the ideation stage through to the
            development of pixel-perfect designs, eventually scaling them into
